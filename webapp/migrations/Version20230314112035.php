 ...
 */
final class Version20230314112035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE board ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL DEFAULT(NOW())');
        $this->addSql('ALTER TABLE board ADD updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL DEFAULT(NOW())');
